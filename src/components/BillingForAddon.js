...
export default function BillingForAddon() {
    ...
    const name=location.state.personData.fullname;
    const phoneNumber=location.state.personData.phoneNumber;
    ...
    async function postData(event) {
        ...
        fetch("https://www.armscon.org.in:5000/addon", {
            method: 'POST',
        ...
        <div id="BillingForAddon_container">
            ...
            <section id="addon_screenshot_container">
                ...
                <Button 
                    ...
                    color="secondary" 
                    fullWidth 
                    sx={{width: '40vw', margin: 'auto', display: values.idCard ? 'block' : 'none'}}
                    onClick={handleClick}
                >
