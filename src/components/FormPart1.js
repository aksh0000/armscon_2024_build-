...
export default function FormPart1(props) {
    ...
    // Course options
    const courses = [
         "MBBS", "BDS", "MD/MS/DNB", "Mch/DM", "B.Pharma/M.Pharma", "B.Nursing/M.Nursing", "BPT/MPT","Others"
    ];
    ...
    const colleges = [
        ...
        "SGT University, Gurgaon", "Adesh Medical College and Hospital, Haryana",
        "N.C. Medical College and Hospital, Panipat","World college , Jhajjar","Al falah medical college,Haryana","Others, please specify :"
    ];
