...
const gpay_link=`gpay://upi/pay?pa=goyal.2002yash@okaxis&pn=yash+goyal&am=${jsonData?.data_to_send?.pricing_}&cu=INR`;
const phonepe_link=`phonepe://pay?am=${jsonData?.data_to_send?.pricing_}&cu=INR&pn=yash%20goyal&pa=goyal.2002yash@okaxis`;
const paytm_link=`paytmmp://pay?pa=goyal.2002yash@okaxis&pn=yash+goyal&am=${jsonData?.data_to_send?.pricing_}&cu=INR`  
