...
import lps from '../assets/lps.jpeg'
  ...
  return (
    <div id="sponsors_container">
        ...
        <main>
            ...
            <Sponsor_card image={lps} title="LPS Bossard"/>
            <Sponsor_card image={sponsor2} title="Adidas"/>
            <Sponsor_card image="https://dncx2j936xcxf.cloudfront.net/static/dist/assets/images/marrow-blue.svg" title="marrow"/>
