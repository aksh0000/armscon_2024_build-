...
const Dashboard = () => {
      ...
      axios.get('https://www.armscon.org.in:5000/dashboard', {
        ...
        .then((response) => {
          ...
          try {
            ...
            localStorage.setItem('mode',response.data.verification)
  ...
  return (
    <div id="dashboard_container">
      ...
      <artilce>
        <h2 style={{display:'flex',alignItems:'left'}}><PersonIcon sx={{border:'1px solid white',padding:'2%',borderRadius:'5px',marginRight:'5%'}}/> {localStorage.getItem('fullname')}</h2>
      ...
      <section id="control_buttons">
        <Link to="/addon"><Button color='secondary' variant='outlined' onClick={()=>alert("Your add on will be updated after 1 hour. \nWe will inform you via email.")}><AddIcon/> Add ons</Button></Link>
