...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (!token) {
      ...
      axios
        .get('https://www.armscon.org.in:5000/dashboard', {
          headers: {
  ...
  return (
    <div id="dashboard_container">
      ...
      <section id="control_buttons">
        <Link to="https://forms.gle/5nvR8TH61rvBJiy6A"><Button color='secondary' variant='outlined' onClick={()=>alert("Your add on will be updated after 12 hours. \nWe will inform you via email.")}><AddIcon/> Add ons</Button></Link>
